...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" Runat="Server">
    <div id="content">
               <asp:ListView runat="server" ID="lv_Articles">
                ...
                <asp:ListView runat="server" ID="lv_MyArt">
                    <LayoutTemplate>
                        <table runat="server">
                            <tr runat="server" id="ItemPlaceHolder"></tr>
                        </table>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td>
                                ...
                                <h1><asp:LinkButton runat="server" Text='<%# Eval("Title") %>' OnClick="Title_Click"/></h1>
                                <br />
                                <asp:RadioButton runat="server" Enabled="false" Checked='<%# Eval("Is_Approved") %>' Text="Approved?"/>
                                <asp:RadioButton runat="server" Enabled="false" Checked='<%# Eval("Is_Rejected") %>' Text="Rejected?"/>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:ListView>
